...
<?php @include("include/secureConfig.php");
  ...
  if(isset($_POST['add']))
  {
    if(!empty($_POST['category']) && !empty($_POST['subcategory']) && isset($_FILES['image']['tmp_name']) && !empty($_FILES['image']['tmp_name'])){
    ...
    $insert=$qm->insertRecordReturn("sub_cate","categoryid,subcategory,img","'".$cate."','".$subcat."','".$Img."'");
      $_SESSION['alert_msg'] .= "<div class='msg_success'>SubCategory added Successfully.</div>";
  ...
  $_SESSION['alert_msg'] .= "<div class='msg_success'>SuCategory added successfully.</div>";
            ...
            <div class="row page-title-header">
              <div class="col-12">
                <div class="page-header">
                  <h5><a href="product_cate.php" style="text-decoration: none;color: black;">Product SubCategory&nbsp;</a> <i class="fa fa-chevron-right"></i> Add Product SubCategory</h5>
                ...
                <div class="card">
                  <div class="card-body">
                    <form class="form-sample" action="" method="Post" enctype="multipart/form-data"> 
                      <p class="card-description"><b><CENTER>Add Product SubCategory</CENTER></p>	
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                              <select class="form-control" id="category" name="category">
                                ...
                                <?php 
                                  $records=$qm->getRecord("product_cate");
