                            ...
                            if (mysqli_num_rows($result)>0) {
                             ...
                             while ($row=mysqli_fetch_array($result)) { ?>
                              <tr>
                                ...
                                <td style="width: 50px;"><a class="btn btn-danger" href="product_cate.php?id=<?php echo $row['id'];?>" onclick="return confirm('Are you sure to want to delete this item ?');">Delete</a><br/></td>
                              </tr>
                            <?php   $cnt=$cnt+1;} } 
                            else {?>
                              <tr>
